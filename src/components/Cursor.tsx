...
export default function Cursor() {
  ...
  useEffect(() => {
    ...
    const onMouseOver = (e: MouseEvent) => {
      ...
      setCustomText(cursorTextEl?.getAttribute('data-cursor-text') ?? '')

      if (cursorEl) {
        setState((cursorEl.getAttribute('data-cursor') as CursorState) || 'open')
    ...
    const render = () => {
      ...
      const targetStretch = Math.min(speed * 0.004, 0.5)
  ...
  }, [showCursor, hideCursor, resetIdleTimer])
