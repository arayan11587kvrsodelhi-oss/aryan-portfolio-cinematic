          ...
          <div className="lg:col-span-7 profile-card flex flex-col justify-between border border-border bg-surface p-6 sm:p-8 md:p-10 rounded-md">
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {['FRONTEND DEVELOPMENT', 'INTERACTIVE WEB', 'WEB SECURITY BASICS', 'UI IMPLEMENTATION'].map((tag) => (
                  <span
                    key={tag}
              ...
              <div className="space-y-4 text-muted text-sm sm:text-base leading-relaxed mt-6">
                <p>
                  I'm a Bachelor of Computer Applications (BCA) student at <span className="text-foreground font-medium">Trinity Institute of Professional Studies (GGSIPU, Delhi)</span>. I build React applications, TypeScript interfaces, interactive web experiences, and security-focused applications — from concept through deployment.
                </p>
                <p>
                  I care about clear typography, responsive layouts, intentional motion, and interfaces that remain usable and accessible on real devices.
                </p>
              </div>
            </div>
