...
export default function LineWaves({
  ...
  useEffect(() => {
    ...
    const effectiveInnerLines = isMobile ? Math.min(innerLineCount, 20) : innerLineCount;
    const effectiveOuterLines = isMobile ? Math.min(outerLineCount, 24) : outerLineCount;
    ...
    program = new Program(gl, {
      ...
      uniforms: {
        ...
        uSpeed: { value: speed },
        uInnerLines: { value: effectiveInnerLines },
        uOuterLines: { value: effectiveOuterLines },
