...
export default function EvilEye({
  ...
  useEffect(() => {
    ...
    // Detect mobile or low power to optimize resolution and texture
    ...
    // Support window mouse tracking if mouse is anywhere in view
    ...
    // Viewport visibility culling: Pause completely when outside viewport
    ...
    // Tab visibility culling: Pause when tab hidden
  ...
  return <div ref={containerRef} className={`evil-eye-container ${className}`.trim()} />;
}
