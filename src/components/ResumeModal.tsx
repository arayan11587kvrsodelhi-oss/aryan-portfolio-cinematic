              ...
              <section aria-labelledby="resume-projects">
                ...
                <div className="space-y-4 text-xs">
                  ...
                  <div className="bg-background/40 border border-border/60 p-4 rounded-md">
                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-1">
                      <div className="flex items-center gap-2">
                        <h3 className="font-display font-medium text-sm text-white">VELORA — Fintech Landing-Page Concept</h3>
                        <span className="text-[0.65rem] border border-accent/40 text-accent px-2 py-0.5 rounded">Concept</span>
                      </div>
                      <span className="text-muted font-mono">JavaScript · HTML5 · CSS3</span>
                    </div>
                    <ul className="mt-2.5 space-y-1 text-muted list-disc list-inside leading-relaxed">
                      <li>Built an interactive fintech landing-page concept with calculators, visualizations, and responsive layouts.</li>
                      <li>Implemented multi-currency display logic and reusable landing-page sections.</li>
                      <li>Deployed the concept demo with a live GitHub Pages pipeline.</li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-background/40 border border-border/60 p-4 rounded-md">
                    ...
                    <ul className="mt-2.5 space-y-1 text-muted list-disc list-inside leading-relaxed">
                      <li>Designed an interactive coffee-concept narrative featuring a draggable roast curve spanning 6 roasting phases.</li>
                      <li>Built a scroll-driven ritual timeline using IntersectionObserver for smooth animations.</li>
                      <li>Engineered responsive layout with explicit image dimensions to reduce layout shift across mobile and desktop.</li>
                    </ul>
                  </div>
