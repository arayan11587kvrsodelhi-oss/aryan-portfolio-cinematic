...
const ENTRIES: TimelineEntry[] = [
  ...
  },
  {
    ...
    description: 'Designing and deploying web projects — including VELORA (fintech landing-page concept), Amber Hour (coffee storytelling experiment), and interactive UI practice builds.',
    icon: Code2,
    tags: ['React', 'TypeScript', 'Framer Motion', 'Lenis', 'Vite'],
  },
  {
    period: 'Ongoing',
    title: 'Web Application Security Studies',
    organization: 'Self-Directed Security Studies',
    description: 'Studying common web application vulnerabilities, authentication flows, client-side input handling, and OWASP-aligned security fundamentals.',
    icon: ShieldCheck,
...
export default function Experience() {
  ...
  return (
    <section id="experience" ref={ref} className="px-4 sm:px-6 md:px-10 py-[var(--spacing-section)] border-t border-border">
      <div className="max-w-container mx-auto">
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-10">
          <div>
            <span className="text-eyebrow text-accent flex items-center gap-2">
              <Sparkles size={13} />
              <span>08 / TIMELINE &amp; MILESTONES</span>
            </span>
        ...
        <div className="mt-8 border-t border-border">
          {ENTRIES.map((entry, i) => (
            <div
              key={entry.title}
              className="timeline-row group grid md:grid-cols-12 gap-6 py-8 md:py-10 border-b border-border items-start"
            >
              <div className="md:col-span-3">
                ...
                <span
                  className="font-mono text-[0.6rem] tracking-[0.22em] text-muted/70 mt-3 block"
                  aria-hidden="true"
                >
