          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            {onOpenResume && (
              <button
                ...
                className="text-eyebrow text-xs border border-border bg-surface/60 hover:border-accent/60 hover:text-accent px-4 py-2 rounded-full transition-all duration-300 flex items-center gap-1.5 min-h-[44px]"
              >
            ...
            <a
              ...
              className="text-eyebrow text-xs border border-accent/50 bg-accent/10 text-accent hover:bg-accent hover:text-background px-4 py-2 rounded-full transition-all duration-300 flex items-center gap-1.5 shadow-[0_0_15px_rgba(53,224,224,0.15)] min-h-[44px]"
            >
