...
const INTENTS = [
  { icon: Code, title: 'Frontend Development', desc: 'React websites, TypeScript interfaces, landing pages, and UI implementation.' },
  { icon: Sparkles, title: 'Interactive Web Experiences', desc: 'Motion, storytelling, and interactive interfaces built with care.' },
  { icon: Briefcase, title: 'Internships & Entry-Level Roles', desc: 'Open to frontend, web, and security-adjacent internships and junior opportunities.' },
...
export default function Contact({ onOpenResume }: ContactProps) {
  ...
  return (
    <section id="contact" className="relative px-4 sm:px-6 md:px-10 pt-[var(--spacing-section)] pb-6 overflow-hidden">
      {/* Background Interactive LineWaves — Closing Atmosphere */}
      <div className="absolute inset-0 pointer-events-none opacity-25 z-0 overflow-hidden" aria-hidden="true">
        <LineWaves
          speed={0.18}
          innerLineCount={24}
          outerLineCount={30}
          ...
          mouseInfluence={1.4}
        />
        {/* Soft edge blend into the animated footer below */}
      ...
      <div className="max-w-container mx-auto flex flex-col items-center text-center relative z-10">
        ...
        <p className="text-muted text-base md:text-xl max-w-2xl mt-6 leading-relaxed">
          Whether you have a frontend project, an internship or entry-level opportunity, or want to connect — my inbox is open.
        </p>
        ...
        {/* Footer Meta Bar */}
        <div className="mt-10 pt-6 border-t border-border/30 w-full flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-muted">
