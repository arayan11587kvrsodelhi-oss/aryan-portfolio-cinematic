...
export default function Hero({ onOpenResume }: HeroProps) {
  ...
  return (
    <section
      id="top"
      ref={rootRef}
      className="hero relative min-h-[100svh] flex flex-col justify-between px-4 sm:px-6 md:px-10 pt-24 sm:pt-28 pb-8 sm:pb-10 overflow-hidden"
    >
      ...
      <div className="hero-fade flex flex-wrap items-end justify-between gap-4 text-eyebrow relative z-10 pt-4 border-t border-border/40">
        ...
        <a
          ...
          onClick={() => playSFX('click')}
          onMouseEnter={() => playSFX('hover')}
          className="flex items-center gap-3 text-muted hover:text-accent transition-colors py-2 min-h-[44px]"
          data-magnetic
          data-cursor="open"
