...
function applyFilter(p: Project, filter: FilterCategory) {
  if (filter === 'FLAGSHIP') return Boolean(p.featured)
...
/* Scroll-driven pinned horizontal slider (desktop >= 1024px) */
  ...
  /* Autoplay — only for the touch fallback carousel (never fights scrubbed scroll) */
  useEffect(() => {
...
{/* ---------------------------------------------------------
          DESKTOP — scroll-driven pinned horizontal track
          --------------------------------------------------------- */}
...
{/* ---------------------------------------------------------
          MOBILE / reduced-motion — touch-friendly carousel
...
{/* ---------------------------------------------------------
          GRID VIEW — all flagship projects as an accessible index
          --------------------------------------------------------- */}
      {viewMode === 'grid' && (
